# -*- coding: utf-8 -*-
"""Smoke-test selected sites through a local proxy."""
...
SYSTEM_PROXY = "http://127.0.0.1:10808"
...
async def test_site(fetcher: SmartFetcher, site_name: str):
    ...
    article_elapsed = (time.monotonic() - article_start) * 1000
    print(
